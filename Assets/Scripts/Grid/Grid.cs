            ...
            if (_showDebug)
            {
                ...
                for (int x = 0; x < _gridArray.GetLength(0); x++)
                    for (int y = 0; y < _gridArray.GetLength(1); y++)
                    {
                        ...
                        _debugTextArray[x, y] = Helper.CreateWorldText(_gridArray[x, y].ToString(), parent, GetWorldPosition(x, y) + new Vector3(cellSize, cellSize) * 0.5f, 20, Color.black, TextAlignment.Center, TextAnchor.MiddleCenter);
